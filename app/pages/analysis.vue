<template>
  <div class="min-h-screen bg-black">
    <div
      class="w-full h-screen relative overflow-hidden bg-gradient-to-br from-blue-950 via-blue-900 to-black"
    >
      <div
        class="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-purple-600/20"
      ></div>
        ...
        <div class="container mx-auto px-4 md:px-20 lg:px-32">
          <div class="max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button
                class="font-sans px-8 py-4 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors duration-200 shadow-lg inline-flex items-center justify-center space-x-3 group text-lg font-bold"
              >
    ...
    <div class="w-full py-16 bg-black border-b border-zinc-800">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        ...
        >
          <div>
            <h2 class="text-3xl font-satoshi font-[900] text-white mb-2">
              Live Session Data
            </h2>
          ...
          <div class="flex space-x-8">
            <div class="text-center">
              <div class="text-3xl font-satoshi font-[900] text-blue-400">
                87
              </div>
            ...
            <div class="text-center">
              <div class="text-3xl font-satoshi font-[900] text-purple-400">
                9.2
              </div>
    ...
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 h-[600px]">
          ...
          <div
            class="lg:col-span-4 bg-zinc-900 rounded-3xl p-8 relative overflow-hidden"
          >
            <div
            ...
            <div class="relative z-10 h-full flex flex-col">
              <div class="flex justify-between items-center mb-8">
                <h3 class="text-3xl font-satoshi font-bold text-white">
                  {{ performanceMetrics[activeMetric].title }} Analysis
                </h3>
                <div class="text-5xl font-satoshi font-[900] text-blue-400">
                  {{ performanceMetrics[activeMetric].value }}
                </div>
              </div>

              <div
                class="flex-1 bg-zinc-800 rounded-2xl p-6 flex items-center justify-center"
              >
    ...
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="mb-16">
          ...
          <p class="text-xl text-white/90 font-general-sans max-w-2xl">
        ...
        <div class="relative">
          ...
          <div class="space-y-8">
            ...
            >
              <div
                class="absolute left-6 w-4 h-4 bg-blue-600 rounded-full border-4 border-black z-10"
              ></div>

              <div
                class="ml-20 bg-zinc-900 rounded-2xl p-6 w-full hover:bg-zinc-800 transition-colors duration-300 cursor-pointer"
                @click="setActiveSession(index)"
              >
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                  <div>
                    <h4 class="text-xl font-satoshi font-bold text-white">
                      {{ session.name }}
                    </h4>
                    <p class="text-white/60">{{ session.date }}</p>
                  </div>
                  <div class="text-center">
                    <div class="text-2xl font-satoshi font-bold text-green-400">
                      {{ session.bestLap }}
                    </div>
                    <div class="text-sm text-white/60">Best Lap</div>
                  </div>
                  <div class="text-center">
                    <div class="text-2xl font-satoshi font-bold text-blue-400">
                      {{ session.laps }}
                    </div>
                  ...
                  <div class="text-center">
                    <div
                      class="text-lg font-satoshi font-bold"
      ...
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              >
                ...
                <div class="bg-zinc-900 rounded-2xl rounded-tl-sm p-6 flex-1">
                  <div class="flex items-center space-x-2 mb-2">
                    <h4 class="font-satoshi font-bold text-white">
                      {{ insight.title }}
                    </h4>
                    <div
                  ...
                  <div class="text-sm text-blue-400 font-general-sans mb-3">
                    {{ insight.action }}
                  </div>
          ...
          <div class="bg-zinc-900 rounded-3xl p-8 h-fit">
            ...
            <div class="space-y-4">
              <button
                class="w-full bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl font-general-sans font-medium transition-colors duration-200"
              >
                Start New Session
              </button>
              <button
                class="w-full bg-zinc-800 hover:bg-zinc-700 text-white p-4 rounded-xl font-general-sans font-medium transition-colors duration-200"
              >
            ...
            <div class="mt-8 p-4 bg-zinc-800 rounded-xl">
              <h4 class="font-satoshi font-bold text-white mb-2">
                Today's Goal
              </h4>
              <p class="text-sm text-white/70 font-general-sans">
    ...
    <div class="w-full py-24 bg-white">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="text-center mb-16">
          <h2
            class="text-5xl md:text-6xl font-satoshi font-[900] text-gray-900 mb-4"
          >
            Riding Crew Leaderboard
          </h2>
          <p class="text-xl text-gray-700 font-general-sans max-w-2xl mx-auto">
        ...
        <div class="flex items-end justify-center space-x-8 mb-12">
          <div class="text-center">
            <div
              class="bg-zinc-900 rounded-3xl p-8 mb-4 h-32 flex items-center justify-center"
            >
              <div class="text-center text-white">
                <div
                  class="w-16 h-16 bg-gradient-to-br from-gray-400 to-gray-600 rounded-full flex items-center justify-center mx-auto mb-2 text-2xl font-bold"
                >
                  S
                </div>
          ...
          <div class="text-center">
            <div
              class="bg-zinc-900 rounded-3xl p-8 mb-4 h-40 flex items-center justify-center"
            >
              <div class="text-center text-white">
                <div
                  class="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-2 text-2xl font-bold"
                >
                  M
                </div>
            ...
            <div class="text-8xl text-yellow-500 font-satoshi font-[900]">
              1
            </div>
          </div>
          ...
          <div class="text-center">
            <div
              class="bg-zinc-900 rounded-3xl p-8 mb-4 h-24 flex items-center justify-center"
            >
              <div class="text-center text-white">
                <div
                  class="w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-2 text-xl font-bold"
                >
                  J
                </div>
            ...
            <div class="text-5xl text-orange-500 font-satoshi font-[900]">
              3
            </div>
          </div>
        </div>
        ...
        <div class="text-center">
          <p class="text-gray-600 font-general-sans mb-6">
            You're 0.7s behind Sarah - time to step up your game!
          </p>
          <button
            class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-general-sans font-medium transition-colors duration-200"
          >
            Challenge Friends
          </button>
        </div>
    ...
    <div class="w-full py-24 bg-white">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            class="md:col-span-2 bg-zinc-900 rounded-3xl p-8 text-white relative overflow-hidden"
          >
            <div
              class="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-purple-600/20"
            ></div>
            <div class="relative z-10">
              <h3 class="text-2xl font-satoshi font-bold mb-2">
              ...
              <div class="grid grid-cols-3 gap-4 mb-6">
                ...
                <div>
                  <div class="text-2xl font-satoshi font-bold text-purple-400">
                    9.4
                  </div>
                  <div class="text-sm text-white/60">Score</div>
                </div>
              ...
              <button
                class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-full font-general-sans font-medium transition-colors duration-200"
              >
                View Details
              </button>
            </div>
          ...
          >
            <h4 class="text-lg font-satoshi font-bold text-gray-900 mb-2">
              {{ ride.name }}
            </h4>
            <p class="text-gray-600 text-sm mb-4">{{ ride.date }}</p>
            <div class="flex justify-between items-center">
              <div>
                <div class="text-xl font-satoshi font-bold text-gray-900">
                  {{ ride.distance }}
                </div>
    ...
    <div class="w-full py-24 bg-white">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div
              class="text-blue-600 font-general-sans text-sm uppercase tracking-wide mb-4"
            >
              Data Ownership
            </div>
            <h3
              class="text-4xl md:text-5xl font-satoshi font-[900] text-gray-900 mb-6"
            >
              Your Data, Your Way
            </h3>
            <p class="text-xl text-gray-700 font-general-sans mb-8">
              Export your riding data in multiple formats. Share with coaches,
              analyze in your favorite tools, or keep private archives. Your
              riding data belongs to you.
            </p>
            <div class="flex flex-wrap gap-4">
              <button
                class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-general-sans font-medium transition-colors duration-200"
              >
                Export CSV
              </button>
              <button
                class="bg-gray-200 hover:bg-gray-300 text-gray-900 px-6 py-3 rounded-full font-general-sans font-medium transition-colors duration-200"
              >
                Download GPX
              </button>
              <button
          ...
          <div
            class="bg-zinc-900 rounded-3xl h-[400px] relative overflow-hidden"
          >
            <div
            ...
            >
              <div class="text-center">
                <div
                  class="w-24 h-24 bg-green-600/30 rounded-full flex items-center justify-center mx-auto mb-6"
                >
                  <svg
                ...
                <h4 class="text-xl font-satoshi font-bold mb-4">
                  Export Options
                </h4>
                <p class="text-white/60 font-general-sans text-sm">
                  CSV, GPX, JSON formats available
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div class="relative z-10 h-full p-8">
              <h4 class="text-xl font-satoshi font-bold text-white mb-6">
                Heat Map Analysis
              </h4>
              ...
              <div class="bg-zinc-800 rounded-2xl h-64 mb-6 p-4 relative">
                <svg class="w-full h-full" viewBox="0 0 300 200" fill="none">
                  ...
                  />
                  <path
                    d="M50 100 Q75 75 100 100"
                    stroke="#ef4444"
                    stroke-width="8"
                    fill="none"
                  />
                  <path
                    d="M100 100 Q125 75 150 100"
                    stroke="#f97316"
                    stroke-width="8"
                    fill="none"
                  />
                  <path
                    d="M150 100 Q175 125 200 100"
                    stroke="#eab308"
                    stroke-width="8"
                    fill="none"
                  />
                  <path
                    d="M200 100 Q225 75 250 100"
                    stroke="#22c55e"
                    stroke-width="8"
                    fill="none"
                  />
              ...
              <div class="grid grid-cols-3 gap-4">
                <div class="text-center">
                  <div class="text-xl font-satoshi font-bold text-red-400">
                    Turn 3
                  </div>
                  <div class="text-xs text-white/60">Risk Zone</div>
                </div>
                <div class="text-center">
                  <div class="text-xl font-satoshi font-bold text-green-400">
                    Turn 7
                  </div>
                  <div class="text-xs text-white/60">Best Performance</div>
                </div>
                <div class="text-center">
                  <div class="text-xl font-satoshi font-bold text-blue-400">
                    12mph
                  </div>
          ...
          <div>
            ...
            <p class="text-xl text-white/90 font-general-sans mb-8">
              Visualize your performance across every section of the track. Our
              heat map analysis identifies where you're losing time and where
              you're excelling, giving you clear targets for improvement.
            </p>
            <div class="space-y-4">
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans"
                  >High-risk zones requiring attention</span
                >
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans"
                  >Moderate improvement opportunities</span
                >
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans"
                  >Optimal performance zones</span
                >
              </div>
            </div>
          </div>
    ...
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <h2
          class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-16"
        >
        ...
        <div class="bg-zinc-900 rounded-3xl p-8">
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="font-satoshi font-bold text-white text-center">
              Your Time
            </div>
            <div class="font-satoshi font-bold text-white text-center">
              Track Record
          ...
          >
            ...
            <div class="text-center text-white font-general-sans">
              {{ sector.yourTime }}
            </div>
            <div class="text-center text-white/70 font-general-sans">
              {{ sector.recordTime }}
            </div>
            <div
              class="text-center font-general-sans"
              :class="sector.diffColor"
            >
              {{ sector.difference }}
            </div>
            <div class="text-center text-green-400 font-general-sans">
              {{ sector.potential }}
            </div>
          </div>
        </div>
      ...
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div class="lg:col-span-2">
            ...
            <div
              class="bg-zinc-900 rounded-3xl p-8 h-[400px] relative overflow-hidden"
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-blue-600/10 to-green-600/10"
              ></div>
              <div class="relative z-10 h-full">
                ...
                <div
                  class="bg-zinc-800 rounded-2xl h-64 p-4 flex items-end justify-center space-x-4"
                >
                  <div
                  ...
                  >
                    <div
                      ...
                      :style="{
                        height: condition.performance + 'px',
                        width: '40px',
                      }"
                      :class="condition.color"
                    ></div>
                    <div class="text-xs text-white/60 font-general-sans">
                      {{ condition.name }}
                    </div>
                  </div>
                </div>
                ...
                <p class="text-white/70 font-general-sans text-sm mt-4">
                  Your best performance occurs in partly cloudy conditions with
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <p class="text-white/70 font-general-sans text-sm mb-2">
                {{ optimal.description }}
              </p>
              <div class="text-xs text-blue-400 font-general-sans">
                {{ optimal.impact }}
              </div>
            </div>
          </div>
    ...
    <div class="w-full py-24 bg-white">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2
              class="text-5xl md:text-6xl font-satoshi font-[900] text-gray-900 mb-8 leading-tight"
            >
              Setup Optimization
            </h2>
            <p class="text-xl text-gray-700 font-general-sans mb-8">
              Track how different bike setups affect your performance. From
              suspension settings to tire pressure, see what configurations work
              best for your riding style and track conditions.
            </p>
              ...
              >
                <div class="flex justify-between items-center">
                  ...
                  <div class="text-right">
                    <div
                      class="font-satoshi font-bold"
                      :class="setup.impactColor"
                    >
                      {{ setup.impact }}
                    </div>
          ...
          >
            <div
              class="absolute inset-0 bg-gradient-to-br from-orange-600/20 to-red-600/20"
            ></div>
            <div
              class="relative z-10 h-full flex items-center justify-center text-white p-8"
            >
              <div class="text-center">
                <div
                  class="w-32 h-32 bg-orange-600/30 rounded-full flex items-center justify-center mx-auto mb-8"
                >
                  <svg
                ...
                <p class="text-white/70 font-general-sans text-sm">
                  Track setup changes and their impact on performance
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="w-full py-24 bg-white">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <h2
          class="text-5xl md:text-6xl font-satoshi font-[900] text-gray-900 mb-16"
        >
          Current Goals
        </h2>
          ...
          >
            <div class="relative z-10">
              <div class="flex items-center justify-between mb-4">
                <h3 class="text-xl font-satoshi font-bold text-gray-900">
                  {{ goal.title }}
                </h3>
                <div
                  class="text-2xl font-satoshi font-[900]"
      ...
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative z-10 h-full p-8">
              ...
              <div class="space-y-6">
                ...
                >
                  ...
                  <div class="text-right">
                    <div
                      class="text-xl font-satoshi font-bold"
                      :class="safety.scoreColor"
                    >
                      {{ safety.score }}
                    </div>
              ...
              <div class="mt-8 p-4 bg-zinc-800 rounded-xl">
                <div class="text-sm text-white/80 font-general-sans">
                  <strong>Safety Tip:</strong> Your braking distances are 15%
                  longer than optimal. Practice threshold braking to improve
                  stopping power.
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <p class="text-xl text-gray-700 font-general-sans mb-8">
              Comprehensive safety analysis helps you ride faster while staying
              safe. Track your risk levels, reaction times, and safety margins
            ...
            <div class="space-y-4">
              <div class="flex items-center space-x-3">
                ...
                <span class="text-gray-700 font-general-sans"
                  >Collision avoidance systems active</span
                >
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-3 h-3 bg-blue-500 rounded-full"></div>
                <span class="text-gray-700 font-general-sans"
                  >Real-time risk assessment</span
                >
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-3 h-3 bg-purple-500 rounded-full"></div>
                <span class="text-gray-700 font-general-sans"
                  >Emergency response integration</span
                >
              </div>
            </div>
          </div>
    ...
    <div class="w-full py-24 bg-gradient-to-br from-blue-600 to-purple-700">
      <div class="container mx-auto px-4 md:px-20 lg:px-32 text-center">
        ...
        >
          Join thousands of riders using data to improve their performance,
          safety, and enjoyment on every ride.
        </p>
        <button
          class="font-sans px-12 py-6 bg-white text-blue-600 rounded-full hover:bg-gray-100 transition-colors duration-200 shadow-lg inline-flex items-center justify-center space-x-3 group text-lg font-bold"
        >
...
const aiInsights = ref([
  {
    ...
    description:
      "Your corner entry speeds are 8% below optimal. Practice trail braking in Turn 2 for better lap times.",
  ...
  },
  {
    ...
    description:
      "You've achieved 95% lap time consistency - placing you in the top 5% of riders.",
  ...
  },
  {
    ...
    description:
      "Front tire temperatures exceeding optimal range in sessions longer than 20 minutes.",
...
const optimalConditions = ref([
  {
    ...
    description: "65-75°F provides best tire grip",
    impact: "+2.3% performance boost",
    color: "bg-blue-500",
  },
  {
    condition: "Track Surface",
    description: "Dry asphalt with minimal wind",
    impact: "+1.8% lap time improvement",
    color: "bg-green-500",
  },
  {
    condition: "Humidity",
    description: "40-60% humidity range optimal",
    impact: "+0.9% consistency boost",
    color: "bg-purple-500",
  },
]);
...
const ridingGoals = ref([
  {
    title: "Sub 1:42 Lap Time",
    description: "Break into the 1:41s at Laguna Seca",
    progress: 75,
  ...
  },
  {
    ...
    description: "Achieve 98% lap time consistency",
    progress: 92,
  ...
  {
    title: "Safety Score",
    description: "Maintain 9.5+ safety rating",
    progress: 88,
...
const safetyMetrics = ref([
  {
    ...
    description: "Average brake response",
    score: 8.7,
    scoreColor: "text-green-400",
    barColor: "bg-green-500",
  },
  {
    metric: "Following Distance",
    description: "Safe spacing maintained",
    score: 9.2,
    scoreColor: "text-green-400",
    barColor: "bg-green-500",
  },
  {
    metric: "Speed Management",
    description: "Appropriate for conditions",
    score: 8.9,
    scoreColor: "text-green-400",
    barColor: "bg-green-500",
  },
  {
    ...
    description: "Hazard awareness score",
    score: 9.4,
    scoreColor: "text-green-400",
    barColor: "bg-green-500",
  },
