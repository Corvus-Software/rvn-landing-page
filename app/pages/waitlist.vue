<template>
  <div class="min-h-screen bg-black">
    ...
    <div class="w-full py-24 bg-black pt-32">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="relative z-10 h-full p-8">
                <div class="flex items-center justify-center h-full">
                  <div class="text-center text-white">
                    <div class="w-56 h-56 bg-gradient-to-br from-red-500 to-orange-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl transform hover:scale-105 transition-transform duration-500">
            ...
            <div class="relative">
              <div class="flex space-x-4 overflow-x-auto scrollbar-hide">
                <div
                    ...
                    :class="{ 'ring-2 ring-red-500': activeProductImage === index }"
                ...
                >
                  ...
                  <div class="relative z-10 h-full flex items-center justify-center text-white">
                    <div class="text-sm font-satoshi font-bold">{{ image.label }}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Right - Product Info -->
          <div class="max-w-2xl">
            <h1 class="text-7xl md:text-8xl font-satoshi font-[900] text-white mb-6 leading-tight">
              RVN
            </h1>
            <h2 class="text-3xl md:text-4xl font-satoshi font-bold text-red-400 mb-8">
              Professional Motorcycle Data Logger
            </h2>

            <!-- Product Description -->
            <p class="text-xl text-white/90 mb-8 font-general-sans">
              Transform your riding with military-grade analytics. RVN captures every detail of your performance with 100Hz precision, providing the same level of data analysis used by professional racing teams.
            </p>
            ...
            <div class="space-y-4 mb-8">
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80 font-general-sans">100Hz data collection with 9-axis IMU sensors</span>
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans">±1m GPS accuracy with emergency crash detection</span>
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans">48-hour battery life with IP68 waterproof rating</span>
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans">Universal mounting system for all motorcycles</span>
              </div>
              <div class="flex items-center space-x-3">
                <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                <span class="text-white/80 font-general-sans">AI-powered insights and global rider community</span>
              </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-2xl p-6 mb-8">
              <div class="flex items-center justify-between">
                <div>
                  <div class="text-4xl font-satoshi font-[900] text-white">${{ earlyBirdPrice }}</div>
                  <div class="text-red-400 font-general-sans line-through text-lg">${{ regularPrice }}</div>
                  <div class="text-white/60 font-general-sans text-sm">Early bird pricing</div>
                </div>
                <div class="text-right">
                  <div class="text-2xl font-satoshi font-bold text-red-400">{{ spotsLeft }}</div>
                  <div class="text-white/70 font-general-sans text-sm">spots left</div>
                </div>
              </div>
            </div>
    ...
    <!-- Tabbed Product Information - BLACK -->
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <!-- Tab Navigation - Normal Style -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div class="bg-zinc-800 rounded-2xl h-48 mb-6 flex items-center justify-center">
              <div class="w-16 h-16 rounded-full flex items-center justify-center" :class="item.iconBg">
                <svg class="w-8 h-8" :class="item.iconColor" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
              </div>
            </div>
            <h3 class="text-xl font-satoshi font-bold text-white mb-4">{{ item.title }}</h3>
            <p class="text-white/70 font-general-sans">{{ item.description }}</p>
          </div>
        </div>
      </div>
    </div>

    <!-- The Future of Riding Data Section - BLACK -->
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="text-center max-w-4xl mx-auto">
          <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-8 leading-tight">
            THE FUTURE
            <br />
            OF RIDING
            <br />
          ...
          <p class="text-xl text-white/90 font-general-sans mb-8">
            Professional-grade motorcycle analytics that help you ride faster, safer, and smarter. Military-precision sensors capture every detail of your ride with 100Hz frequency.
          </p>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div class="text-center">
              <div class="text-4xl font-satoshi font-[900] text-red-400 mb-2">100Hz</div>
              <div class="text-white/60 font-general-sans">Data Collection Rate</div>
            </div>
            <div class="text-center">
              <div class="text-4xl font-satoshi font-[900] text-red-400 mb-2">±1m</div>
              <div class="text-white/60 font-general-sans">GPS Precision</div>
            </div>
            <div class="text-center">
              <div class="text-4xl font-satoshi font-[900] text-red-400 mb-2">48hrs</div>
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-6">Integrated with RAi</h2>
            <p class="text-xl text-white /90 font-general-sans mb-8">
              ...
              >
                ...
                <div>
                  <h3
                      ...
                      :class="activeRaiCapability === index ? 'text-red-400' : 'text-white '"
                  >
                    {{ capability.title }}
                  </h3>
                  <p
                      class="font-general-sans text-sm transition-colors duration-300"
                      :class="activeRaiCapability === index ? 'text-white/90' : 'text-white /60'"
                  >
            ...
            <div class="grid grid-cols-2 gap-6">
              <div>
                ...
                <div class="text-sm text-white /60 font-general-sans">Available</div>
              </div>
              <div>
                <div class="text-2xl font-satoshi font-bold text-red-400 mb-2">100M+</div>
                <div class="text-sm text-white /60 font-general-sans">Data Points Analyzed</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Advanced Safety Section - BLACK -->
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <!-- Left - Text Content -->
          <div>
            <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-8 leading-tight">Advanced Safety</h2>
            <p class="text-xl text-white/90 font-general-sans mb-8">
              AI-powered safety monitoring keeps you protected on every ride. Our emergency detection system has already triggered 23 life-saving responses, automatically notifying emergency contacts with your precise GPS location.
            </p>
            <p class="text-lg text-white/80 font-general-sans">
              Beyond emergency response, RVN continuously analyzes your riding patterns to identify potential risks and provide personalized safety recommendations.
            </p>
          </div>
          ...
          <div class="bg-zinc-900 rounded-3xl h-[500px] relative overflow-hidden">
            ...
            <div class="relative z-10 h-full flex items-center justify-center text-white p-8">
              <div class="text-center">
                <div class="w-32 h-32 bg-red-600/30 rounded-full flex items-center justify-center mx-auto mb-8">
                ...
                <h4 class="text-2xl font-satoshi font-bold mb-4">Emergency Response</h4>
                <p class="text-white/70 font-general-sans">Automatic crash detection & alerts</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Riding Community Section - BLACK -->
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <!-- Left - Visual -->
          <div class="bg-zinc-900 rounded-3xl h-[500px] relative overflow-hidden">
            ...
            <div class="relative z-10 h-full flex items-center justify-center text-white p-8">
              <div class="text-center">
                <div class="w-32 h-32 bg-green-600/30 rounded-full flex items-center justify-center mx-auto mb-8">
                  <svg class="w-16 h-16 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/>
                  </svg>
                </div>
                <h4 class="text-2xl font-satoshi font-bold mb-4">Global Network</h4>
                <p class="text-white/70 font-general-sans">50,000+ riders worldwide</p>
              </div>
            </div>
          </div>
          ...
          <!-- Right - Text Content -->
          <div>
            <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-8 leading-tight">Riding Community</h2>
            <p class="text-xl text-white/90 font-general-sans mb-8">
              Connect with over 50,000 riders across 127 countries. Share routes, compare performance, and learn from the best riders in your area. Discover new riding spots and challenge friends to beat your times.
            </p>
            <p class="text-lg text-white/80 font-general-sans">
              The RVN community isn't just about data – it's about sharing the passion for riding and helping each other become better, safer riders.
            </p>
          </div>
        </div>
      </div>
    ...
    <!-- Image Carousel - BLACK -->
    <div class="w-full py-24 bg-black">
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-16 text-center">See RVN in Action</h2>

        <!-- Carousel Container -->
        <div class="relative">
          <!-- Images with Active Item in Middle -->
          <div class="flex justify-center items-center space-x-6 mb-8">
            <div
                ...
                :class="[
                  image.isActive ? 'h-80 w-80 ring-4 ring-red-500 scale-105' : 'h-64 w-64 opacity-60',
                  image.isActive ? 'z-10' : 'z-0'
                ]"
                @click="setActiveCarousel(image.originalIndex)"
            >
              <div class="absolute inset-0" :class="image.gradient"></div>
              <div class="relative z-10 h-full flex items-center justify-center text-white p-6">
                <div class="text-center">
                  <div class="rounded-full flex items-center justify-center mx-auto mb-4"
                    ...
                    <svg :class="[image.isActive ? 'w-10 h-10' : 'w-8 h-8', image.iconColor]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                  </div>
                  <h4 :class="[image.isActive ? 'text-xl' : 'text-lg', 'font-satoshi font-bold mb-2']">{{ image.title }}</h4>
                  <p :class="[image.isActive ? 'text-base' : 'text-sm', 'text-white/70 font-general-sans']">{{ image.description }}</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="w-full py-24 bg-white">
    <div class="container mx-auto px-4 md:px-20 lg:px-32">
      <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-gray-900 mb-16 text-center">What Riders Say</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <div class="flex items-center space-x-4 mb-6">
            ...
            <div>
              <h4 class="font-satoshi font-bold text-gray-900">{{ review.name }}</h4>
          ...
          <div class="flex space-x-1 mb-4">
            <svg v-for="n in 5" :key="n" class="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
            </svg>
          </div>

          <p class="text-gray-700 font-general-sans italic mb-4">"{{ review.quote }}"</p>
          <div class="text-sm text-gray-500 font-general-sans">{{ review.bike }}</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="w-full py-24 bg-white">
    <div class="container mx-auto px-4 md:px-20 lg:px-32">
      <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-gray-900 mb-16 text-center">Frequently Asked Questions</h2>
  ...
  <div class="w-full py-24 bg-gradient-to-br from-red-600 to-orange-600">
    <div class="container mx-auto px-4 md:px-20 lg:px-32 text-center">
      <h2 class="text-5xl md:text-6xl font-satoshi font-[900] text-white mb-8">Ready to Transform Your Rides?</h2>
      <p class="text-xl text-white/90 font-general-sans max-w-2xl mx-auto mb-12">
        Join {{ totalSpots - spotsLeft }} riders who have already reserved their spot. Only {{ spotsLeft }} remaining in our first batch.
      </p>
      <button
          @click="openWaitlistModal"
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 transition-transform duration-200 group-hover:translate-y-[-2px]" viewBox="0 0 20 20" fill="currentColor">
  ...
  <!-- Waitlist Modal -->
  <div v-if="showWaitlistModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-zinc-900 rounded-3xl p-8 max-w-md w-full mx-auto">
      <!-- Close Button -->
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-2xl font-satoshi font-bold text-white">Join Waitlist</h3>
        <button
      ...
      <div class="bg-zinc-800 rounded-2xl p-4 mb-6">
        <div class="flex justify-between items-center">
          <div>
            <div class="text-3xl font-satoshi font-[900] text-red-400">{{ spotsLeft }}</div>
            <div class="text-white/70 font-general-sans text-sm">Spots Remaining</div>
          </div>
          <div class="text-right">
            <div class="text-xl font-satoshi font-bold text-white">${{ earlyBirdPrice }}</div>
            <div class="text-red-400 font-general-sans line-through text-sm">${{ regularPrice }}</div>
          </div>
        </div>
      </div>
      ...
      <form @submit.prevent="submitWaitlist" class="space-y-4">
        ...
        <div>
          ...
          >
            <option value="" disabled class="bg-zinc-800">Select your bike type</option>
  ...
  <div v-if="showSuccessModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl p-8 max-w-md w-full mx-auto text-center">
      ...
      <h3 class="text-2xl font-satoshi font-bold text-gray-900 mb-4">You're In!</h3>
      <p class="text-gray-700 font-general-sans mb-6">
        Welcome to the RVN waitlist. You're #{{ userPosition }} in line. We'll email you with updates and priority access when we launch.
      </p>
      <button
...
const productImages = ref([
  { label: 'Front', gradient: 'bg-gradient-to-br from-red-600/20 to-orange-600/20' },
  { label: 'Side', gradient: 'bg-gradient-to-br from-blue-600/20 to-purple-600/20' },
  { label: 'Back', gradient: 'bg-gradient-to-br from-green-600/20 to-teal-600/20' },
  { label: 'Mount', gradient: 'bg-gradient-to-br from-purple-600/20 to-pink-600/20' },
  { label: 'Size', gradient: 'bg-gradient-to-br from-yellow-600/20 to-orange-600/20' }
])
...
const productTabs = ref([
  {
    ...
    items: [
      {
        title: 'Mount & Ride',
        description: 'Secure RVN to your bike in under 5 minutes with our magnetic mounting system. No tools or modifications required.',
        iconBg: 'bg-blue-600/30',
        iconColor: 'text-blue-400'
      },
      {
        title: 'Automatic Tracking',
        description: 'RVN automatically detects when you start riding and begins collecting data at 100Hz frequency.',
        iconBg: 'bg-green-600/30',
        iconColor: 'text-green-400'
      },
      {
        title: 'Review & Improve',
        description: 'Access detailed analytics on your phone or computer. Track progress and get AI-powered insights.',
    ...
    items: [
      {
        ...
        description: '9-axis IMU with gyroscope, accelerometer, and magnetometer for accurate motion tracking.',
        iconBg: 'bg-red-600/30',
        iconColor: 'text-red-400'
      },
      {
        title: 'GPS Module',
        description: 'Multi-constellation GNSS receiver with ±1m accuracy and 10Hz positioning updates.',
        iconBg: 'bg-blue-600/30',
        iconColor: 'text-blue-400'
      },
      {
        title: 'Connectivity',
        description: '5G cellular, WiFi, and Bluetooth for seamless data synchronization and real-time features.',
        iconBg: 'bg-green-600/30',
        iconColor: 'text-green-400'
      }
    ]
  },
  {
    ...
    items: [
      {
        title: 'RVN Device',
        description: 'Main data logging unit with all sensors, GPS, and connectivity built-in. IP68 waterproof rating.',
        iconBg: 'bg-orange-600/30',
        iconColor: 'text-orange-400'
      },
      {
        title: 'Mounting Kit',
        description: 'Magnetic mount, adhesive base, and security tether. Compatible with all motorcycle types.',
        iconBg: 'bg-purple-600/30',
        iconColor: 'text-purple-400'
      },
      {
        title: 'Charging Cable',
        description: 'USB-C charging cable and wall adapter. Full charge provides 48 hours of continuous operation.',
...
const customerReviews = ref([
  {
    ...
    quote: 'Been beta testing for 6 months. RVN has completely changed how I approach track days. The data is incredible.',
    bike: 'Yamaha R1M'
  },
  {
    name: 'Sarah Williams',
    initial: 'S',
    location: 'Austin, TX',
    quote: 'Finally, professional-grade data for regular riders. The safety features alone are worth it.',
  ...
  },
  {
    ...
    initial: 'J',
    location: 'Denver, CO',
    quote: 'Easy installation, amazing insights. Dropped 2 seconds off my lap time in just one session.',
...
const faqs = ref([
  {
    ...
    answer: 'First batch production begins in Q2 2025. Waitlist members will receive their devices starting in June 2025, with all first batch orders fulfilled by August 2025.',
    isOpen: false
  },
  {
    question: 'Do I pay anything to join the waitlist?',
    answer: 'No payment is required to join the waitlist. You\'ll only pay when you decide to purchase after receiving your exclusive early access invitation.',
    isOpen: false
  },
  {
    question: 'How much will I save as a waitlist member?',
    answer: 'Waitlist members get $100 off the regular retail price, plus exclusive access to limited edition colors and priority customer support.',
    isOpen: false
  },
  {
    question: 'What motorcycles does RVN work with?',
    answer: 'RVN is universally compatible with all motorcycles. Our mounting system works with sport bikes, touring bikes, cruisers, adventure bikes, and more.',
    isOpen: false
  },
  {
    question: 'How accurate is the data?',
    answer: 'RVN provides professional-grade accuracy with ±1m GPS precision and sub-degree lean angle measurements. Our 9-axis IMU sensors ensure you get the most precise riding data available.',
    isOpen: false
  }
])
...
const previousCarousel = () => {
  activeCarouselIndex.value = activeCarouselIndex.value === 0
...
definePageMeta({
  ...
  description: 'Professional-grade motorcycle analytics. Join the waitlist for exclusive early access.'
})
</script>
