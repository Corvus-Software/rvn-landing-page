      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p class="text-xl text-white/90 font-general-sans mb-8">
            Track your progression across multiple track sessions and discover
            patterns that unlock consistent performance improvements.
          </p>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-white/60">
                    {{ session.date }} • {{ session.laps }} laps
                  </p>
                </div>
        ...
        >
          <div
            class="absolute inset-0 bg-gradient-to-br from-purple-600/10 to-blue-600/10"
          ></div>
          <div class="relative z-10 h-full">
            <h3 class="text-2xl font-satoshi font-bold text-white mb-6">
              {{ sessionData[activeSession].name }}
            </h3>

            <div
              class="bg-zinc-800 rounded-2xl h-64 mb-6 p-4 flex items-end justify-center space-x-2"
            >
              <div
            ...
            <div class="mt-6 p-4 bg-zinc-800 rounded-xl">
              <div class="text-sm text-white/80 font-general-sans">
                ...
                {{ sessionData[activeSession].insight }}
              </div>
            </div>
          </div>
        </div>
...
const sessionData = ref([
  {
    ...
    insight:
      "Consistent improvement in sector 2 times, focus on late braking technique",
  ...
  },
  {
    ...
    trendColor: "text-green-400",
    insight:
      "Good progress on turn 3 entry, work on maintaining speed through chicane",
  ...
  },
  {
    ...
    insight:
      "Tire degradation affected later laps, consider tire pressure adjustments",
    lapTimes: [
      90, 88, 85, 80, 78, 75, 73, 70, 72, 75, 78, 80, 82, 85, 87, 89, 90, 92,
    ],
  },
]);
