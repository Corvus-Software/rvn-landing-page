<template>
  <div class="w-full py-24 bg-black">
    ...
    >
      ...
      <div
        class="bg-zinc-900 rounded-3xl p-8 h-[37rem] flex items-center justify-center mb-16"
      >
        <div class="text-center">
          <h3 class="text-2xl font-satoshi font-bold text-white mb-4">
            {{ activeTab.title }}
          </h3>
        ...
        >
          <div class="relative pb-4 mb-6">
            <h3
              ...
              :class="
                activeTabIndex === index ? 'text-green-500' : 'text-gray-400'
              "
            >
              {{ tab.title }}
            </h3>
            <p
              ...
              :class="
                activeTabIndex === index ? 'text-green-400' : 'text-gray-500'
              "
            >
              {{ tab.subtitle }}
            </p>
          ...
          <div class="transition-all duration-300">
            <p
              ...
              :class="
                activeTabIndex === index ? 'text-white/80' : 'text-gray-600'
              "
            >
              {{ tab.description }}
            </p>
...
const tabs = ref([
  {
    ...
    description:
      "Track your speed, lean angles, braking patterns, and acceleration to understand your riding style and identify areas for improvement.",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "Get intelligent safety recommendations based on your riding patterns, weather conditions, and road analysis to stay safe yet fast on every ride.",
    bulletPoints: [
  ...
  },
  {
    ...
    description:
      "Receive customized training recommendations and track your progress over time with detailed analytics and coaching insights.",
    bulletPoints: [
