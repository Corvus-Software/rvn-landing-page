...
<template>
  <div class="w-full h-screen relative overflow-hidden">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0 bg-gradient-to-br from-red-950 via-red-900 to-black">
      ...
      <div class="container mx-auto px-4 md:px-20 lg:px-32">
        <div class="max-w-4xl">
          ...
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-10 font-general-sans">
            RVN is your AI-powered data logger that provides insights and post-ride analysis to help you become a better rider.
          </p>
          <button
            ref="heroSection"
          ...
          >
            <span class="tracking-[2px] text-[.8125rem] uppercase">JOIN THE WAITLIST</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform duration-200 group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
